 ...
 * @author willi
 */
public class TelaCadReservarController implements Initializable {
    ...
    @FXML
    private AnchorPane telaCadastrarReservalPane;
    ...
    @FXML
    private DatePicker dataLocacaoReservaDate;

    @FXML
    private Button novoReservaButton;

    @FXML
    private ComboBox<?> statusReservaComboBox;

    @FXML
    private ComboBox<?> categoriaReservaComboBox;

    @FXML
    private TextField valorReservaField;

    @FXML
    private TextField clientePesquisaReservaField;

    @FXML
    private ImageView addClienteReservaIcon;

    @FXML
    private Button salvarReservaButton;

    @FXML
    private TextField pesquisarReservaField;

    @FXML
    private DatePicker pesquisarPInicialReservaDate;

    @FXML
    private DatePicker pesquisarPfinalReservaDate;

    @FXML
    private ImageView pesquisarResevaIcon;

    @FXML
    private ComboBox<?> pesquisarStatusResevarComboBox;

    @FXML
    private ImageView imprimirReservaIcon;

    @FXML
    private TableView<?> tabelasReservaTable;
    ...
    @FXML
    void imprimirResevas(MouseEvent event) {
    ...
    @FXML
    void novaReserva(ActionEvent event) {

    }

    @FXML
    void procurarReservaIcon(MouseEvent event) {

 ...
 * @author willi
 */
public class TelaCadVeiculosController implements Initializable {
    ...
    @FXML
    private ComboBox<?> statusVeiculoComboBox;

    @FXML
    private Button salvarLocacaoButton;

    @FXML
    private TextField nPlacaField;
    ...
    @FXML
    private TextField pesquisarveiculosField;

    @FXML
    private DatePicker periodoInicialDate;

    @FXML
    private DatePicker periodoFinalDate;

    @FXML
    private ImageView pesquisarIcon;

    @FXML
    private ComboBox<?> pesquisarStatusVeiculoComboBox;

    @FXML
    private ImageView imprimirIcon;
    ...
    @FXML
    void imprimirIcon(MouseEvent event) {
    ...
    @FXML
    void novoMotorista(ActionEvent event) {

    }

    @FXML
    void pesquisarIcon(MouseEvent event) {
